...
const CPepeEngineVector3* CPepeEngineAxisAlignedBox::getAllCorners(void) const
{
    ...
    */
    ...
    m_pCorners[1].x = m_minimum.x;
    m_pCorners[1].y = m_maximum.y;
    m_pCorners[1].z = m_minimum.z;
    m_pCorners[2].x = m_maximum.x;
    m_pCorners[2].y = m_maximum.y;
    m_pCorners[2].z = m_minimum.z;
    m_pCorners[3].x = m_maximum.x;
    m_pCorners[3].y = m_minimum.y;
    m_pCorners[3].z = m_minimum.z;

    m_pCorners[4] = m_maximum;
    m_pCorners[5].x = m_minimum.x;
    m_pCorners[5].y = m_maximum.y;
    m_pCorners[5].z = m_maximum.z;
    m_pCorners[6].x = m_minimum.x;
    m_pCorners[6].y = m_minimum.y;
    m_pCorners[6].z = m_maximum.z;
    m_pCorners[7].x = m_maximum.x;
    m_pCorners[7].y = m_minimum.y;
    m_pCorners[7].z = m_maximum.z;
