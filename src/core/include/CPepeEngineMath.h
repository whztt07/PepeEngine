...
public:
	...
	static inline float Cos(const Radian& fValue) {return float(cos(fValue.valueRadians()));}	
	static inline float Cos(float fValue) {return float(cos(fValue));}
	...
	static inline float Sin(const Radian& fValue) {return float(sin(fValue.valueRadians()));}	
	static inline float Sin(float fValue) {return float(sin(fValue));}
	...
	static inline float Tan(const Radian& fValue) {return float(tan(fValue.valueRadians()));}        
	static inline float Tan(float fValue) {return float(tan(fValue));}
