...
public:
	...
	const CullingMode& getCullingMode() const {return m_cullingMode;}
	const PolygonMode& getPolygonMode() const {return m_polygonMode;}
	const ShadeMode& getShadeMode() const {return m_shadeMode;}

	inline size_t getFacesCount() const;
	inline void resetFacesCount();

	virtual void initCapabilities() = 0;
	const CPepeEngineRendererCapabilities* getRendererCapabilities() const {return m_pCapabilities;}
	...
	IPepeEngineRenderWindow* getRenderWindow() const {return m_pRenderWindow;}
	IPepeEngineVideoModeList* getVideoModeList() const {return m_pVideoModeList;}	
