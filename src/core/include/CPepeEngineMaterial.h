...
public:
    ...
    GPUProgramPtr getPixelShader() const {
        return m_pPSGPUProgram;
    }
    GPUProgramPtr getVertexShader() const {
        return m_pVSGPUProgram;
    }
    TexturePtr getTexture() const {
        return m_pTexture;
    }

    bool hasGPUProgram() const {
        return m_bHasGPUProgram;
    }
    bool hasVertexShader() const {
        return m_pVSGPUProgram != NULL;
    }
    bool hasPixelShader() const {
        return m_pPSGPUProgram != NULL;
    }
