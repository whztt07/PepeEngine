...
public:
	...
	LPDIRECT3DTEXTURE9 getD3D9Texture() const {return m_pNormTexture;}
	LPDIRECT3DCUBETEXTURE9 getD3D9CubeTexture() const {return m_pCubeTexture;}
	LPDIRECT3DVOLUMETEXTURE9 getD3D9VolumeTexture() const {return m_pVolumeTexture;}
};
