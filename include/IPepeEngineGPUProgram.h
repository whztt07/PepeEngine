...
public:
    ...
    void setTransposeMatrices(bool bTransposeMatrices) {
        m_bTransposeMatrices = bTransposeMatrices;
    }
...
public:
    ...
    CPepeEngineGPUProgramParameters* getParameters() {
        return &m_parameters;
    }
