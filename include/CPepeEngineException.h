...
public:
	...
	virtual const tstring& getDescription() const {return m_strDescription;}
	virtual const tstring& getSource() const {return m_strSource;}
	virtual const tstring& getType() const {return m_strType;}
	virtual const char* getFile() const {return m_strFile;}

	virtual int getLine() const {return m_lLine;}

	/**
	 * Override std::exception::what
	 */
	const char* what() const throw() { return (char *)getFullDescription().c_str(); }	
};
