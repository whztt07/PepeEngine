...
public:
	...
	const tstring& getPSShaderModel() const {return m_strDefPSShaderModel;}

	void setVSShaderModel(const tstring& strShaderModel);
	const tstring& getVSShaderModel() const {return m_strDefVSShaderModel;}
	
	void setVSEntryPoint(const tstring& strEntryPoint) {m_strDefVSEntryPoint = strEntryPoint;}
	const tstring& getVSEntryPoint() const {return m_strDefVSEntryPoint;}

	void setPSEntryPoint(const tstring& strEntryPoint) {m_strDefPSEntryPoint = strEntryPoint;}
	const tstring& getPSEntryPoint() const {return m_strDefPSEntryPoint;}

	void pushSyntaxCode(const tstring& strCode) {m_syntaxCodes.push_back(strCode);}
